...
def read_iris():
    ...
    if not str(iris_in_meta_path).startswith('data/iris'):
        raise FileNotFoundError(f"Folder '{str(iris_in_meta_path)}' does not exist. Please download the IRIS dump and place it in the 'data/' folder.")
